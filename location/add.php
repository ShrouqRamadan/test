...
if(isset($_POST['submit'])){
   $name= $_POST['name'];
    ...
    $insert="INSERT INTO `location` VALUES(Null,'$name')";
...
if(isset($_POST['update'])){
  $name= $_POST['name'];
  $up="UPDATE `location` SET room='$name' WHERE id=$id ";
   mysqli_query($conn,$up);
   header('location:/unii/location/List.php');
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-12 text-left section-heading probootstrap-animate">
              <?php  if($update) :?>
            <h1 class="mb0"><span>Welcome to</span><br> update Locations Page</h1>
            <?php else :?>
              <h1 class="mb0"><span>Welcome to</span><br> Add Locations Page</h1>
<?php endif ;?>
