...
$select="SELECT doctor.id,doctor.name doctor,courses.cour course,courses.abbreviation FROM coursedr JOIN doctor ON coursedr.doctorid=doctor.id JOIN courses ON coursedr.coursesid1 AND coursedr.coursesid2;";
