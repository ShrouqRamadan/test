...
<?php
$select="SELECT student.id,name,years,phone,email,password FROM `student` JOIN levels on student.levelid=levels.id;";
$sql=mysqli_query($conn,$select);
#======================
$selects="SELECT * From student";
$sqls=mysqli_query($conn,$select);
#============
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-12 text-left section-heading probootstrap-animate">
              <h1 class="mb0">List Of Student</h1>
            </div>
          </div>
        </div>
      </section>
